package ru.hackathon.sovcombankchallenge.vacancy.specifications;
...
public class VacancySpecification implements Specification<Vacancy> {
    ...
    @Override
    public Predicate toPredicate(Root<Vacancy> root, CriteriaQuery<?> query, CriteriaBuilder builder) {
